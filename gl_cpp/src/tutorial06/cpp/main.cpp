/**
 * Tutorial05 - Translations (OpenGL 4.5)
 * 
 * Draws a Triangle in the center of the screen using shaders.
 * The triangle is then transformed by a translation matrix.
 * Uses OpenGL 4.5
 */
...
int main(int argc, char** argv) {
    ...
    auto window = glfwCreateWindow(640, 480, "Tutorial06", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window)) {
        auto trModel = glm::translate(glm::mat4(1.0), glm::vec3(static_cast<float> (std::cos(t)), 0.0F, 0.0F));
